...
public record UnravelConfig : ApiConfig
{
    ...
    public string UrlPathFactors { get; init; } = "portfolio/factors?id={0}&tickers={1}&smoothing={2}&start_date={3}&end_date={4}";

    public string UrlPathUniverse { get; init; } = "portfolio/universe?size={0}&exchange={1}&start_date={2}&end_date={3}";
}